...
#ifndef _CV32E40_CORE_H
#define _CV32E40_CORE_H
...
#define CSR_MCAUSE_EXCEPTION_POS 0

#define CSR_MCAUSE_INTERRUPT_MASK (1 << CSR_MCAUSE_INTERRUPT_POS)
#define CSR_MCAUSE_EXCEPTION_MASK (0x1F << CSR_MCAUSE_EXCEPTION_POS)

#define CSR_EXCEP_INSTR_ILLEGAL 2
#define CSR_EXCEP_BREAKPOINT 	3
#define CSR_EXCEP_ECALL 		11
#endif
